...
######################################################
### Script: 08#T_Diet_Weight

### Prediction 3: Individual nestlings weight and dietary specialisation
### Latex ready tables for models 07_M
...
m1 <- read.csv("Output/Models/M_B_Indiv_Weight_Diet_240626.csv", header=TRUE)
m2 <- read.csv("Output/Models/M_G_Indiv_Weight_Diet_240626.csv", header=TRUE)
...
estimate_w_rows <- c("beta_0_w_u",
                     ...
                     "b_int_u.3.",
                     "b_int_u.4.",
                     "V_spy_w",  "V_brood_w", "V_e_w",
                     "VC_spy_w","VC_brood_w",  "VC_e_w",
...
m1_combined1$Latex_names <- c("\\text{Intercept}", 
                              ...
                              "\\text{Subplot year}", "\\text{Brood ID}", "\\text{Residual}",
                              "\\text{Subplot year}", "\\text{Brood ID}", "\\text{Residual}",
                              # effects of weight
