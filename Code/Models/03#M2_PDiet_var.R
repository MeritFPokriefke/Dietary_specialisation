...
######################################################
### Script: 03#M2_PDiet_var

### Variation in preferred prey: Variation in prey preferences
### Refitted Bayesian STAN models to determine variation in prey preferences at multiple hierarchical levels,
...
######################################################################################################## all ----
### df with bird type of adult and nestling for both species (A,C; all)
...
md <- stan("Code/Models/Mod3.2.stan", data = dfl, seed = 2108905166,
           chains = 4, iter = 5000,  warmup = 2000, 
           thin = 1, cores = 4, control = list(adapt_delta = 0.95))

### save output locally
saveRDS(md, file = "Output/Models/M2_All_pdiet_var_040925.rds")
...
### save output
write.csv(dat_zip, "Output/Models/M2_All_pdiet_var_040925.csv")
...
md <- stan("Code/Models/Mod3.1.2.stan", data = dfl, seed = 1280916776,
           chains = 4, iter = 5000,  warmup = 2000, 
           thin = 1, cores = 4, control = list(adapt_delta = 0.95))

saveRDS(md, file = "Output/Models/M2_B_pdiet_var_040925.rds")
...
write.csv(dat_zip, "Output/Models/M2_B_pdiet_var_040925.csv")
...
md <- stan("Code/Models/Mod3.1.2.stan", data = dfl, seed = 2110818207,
           chains = 4, iter = 4000,  warmup = 2000, 
           thin = 1, cores = 4, control = list(adapt_delta = 0.95))

saveRDS(md, file = "Output/Models/M2_G_pdiet_var_040925.rds")
...
write.csv(dat_zip, "Output/Models/M2_G_pdiet_var_040925.csv")
