...
parameters {
  ...
  matrix[J, 6] b;                      // fixed effects per order (3 covariates)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  for (n in 1:N_z) {
    z_s[n] ~ normal(mu + 
                    ...
                    + be[4] .* Time[n] + be[5] .* Sex[n] + be[6] .* G[n] +
...
// Backtransformation for E
  ...
  vector[6] be_u;                    // Back-transform fixed effects
  for (i in 1:6) {
    be_u[i] = be[i] * z_sd;
  }  
